...
class Sslcare_Admin_Setting
{
	...
	public function sslcare_admin_sms_template_callback() {
	    ...
	    $sslcare_admin_sms_template = "Order has been placed by {{name}} from {{cus_phone}}, order is {{status}}, total amount is {{amount}} {{currency}} for order id {{order_id}}.\nThank You\n".get_bloginfo('name');
	    ...
	    $html .= '<br><label for="sslcare_admin_sms_template"><b>Variables : </b>{{name}}, {{status}}, {{amount}}, {{currency}}, {{order_id}}, {{cus_phone}}</label>';
	    $html .= '<hr>';
